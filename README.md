...
cp -r media/songsee ~/.hermes/skills/media/songsee/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/songsee-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/songsee-skill.git ~/.hermes/skills/media/songsee/
```
...
```text
Use the songsee skill to <describe your specific task here>
```
...
```text
Gunakan skill songsee untuk <deskripsikan tugas spesifik Anda di sini>
```
